...
ENTRIES = [
    ...
    ("Ex. : @contoso.com — seuls les comptes dont l'email se termine ainsi sont traités.", None,
     "Ex. : @contoso.com — seuls les comptes dont l'email se termine ainsi sont traités.",
     "E.g. @contoso.com — only accounts whose e-mail ends this way are processed."),
